                ...
                <Row>
                    ...
                    <Col lg={6}>
                        ...
                        <Form.Group className="mb-3">
                            ...
                            <Form.Control type="text" placeholder="Image URL" name="img" value={this.state.img} onChange={this.changeHandler} />
                        </Form.Group>
                        ...
                        <Form.Group className="mb-3">
                            ...
                            <Form.Control as="textarea" placeholder="Write the Product description" rows={3} name="desc" value={this.state.desc} onChange={this.changeHandler} />
                        </Form.Group>
